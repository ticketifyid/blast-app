            ...
            <form action="{{ route('templates.store') }}" method="POST">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        ...
                        <button type="button" id="toggle-source" class="btn btn-outline-secondary btn-sm" style="{{ old('channel', 'wa') === 'wa' ? 'display:none' : '' }}" onclick="toggleSource()">
                            &lt;/&gt; Source HTML
                        </button>
                    </div>
                    {{-- WA: plain textarea --}}
...
@push('scripts')
    ...
    <script>
        ...
        function toggleSource() {
            ...
            if (!sourceMode) {
                // Switch to source mode: copy Quill HTML to textarea
                ...
                // Switch back to visual: load textarea HTML into Quill
